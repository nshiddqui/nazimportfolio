            ...
            <div class="col-md-12">
                <div class="portfolio">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 mix frontend wow flipInX">
                            <a data-toggle="modal" data-name="501 Games" target="_blank" title="501 Games" href="https://www.501va.com" class="portfolio-box">
                                <div class="portfolio-img">
                                    <?= $this->Html->image('preloader.gif', ['alt' => '501 Games', 'data-url' => 'https://www.501va.com']) ?>
                                </div>
                                <div class="portfolio-name">
